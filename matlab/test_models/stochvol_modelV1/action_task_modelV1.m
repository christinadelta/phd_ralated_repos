...
config      = struct('tvolatile',tvolatile,'tstable',tstable,'state',x,'rng_id',0,'nsim',20,'model_parameters',params);
...
h = plot_bar(1,1,subplots(1),{mxx},{exx},{'Low anxiety','High anxiety'},{'Performance','Performance'},'',col);
set(h,'ylim',[0 1]);
