function data = ALsimdata_v3(probabilities, trials,condtrials, outtype)
...
for j = 1:NumStoch
    ...
    for i = 1:NumVol
        ...
        % add cues and outcomes in stable and volatile matrix
        if i == 1
            allcues        = cues;
            alloutcomes    = outcomes;
        else
            volcues        = cues;
            voloutcomes    = outcomes;
        end
    ...
    xfinal              = [x; x_vol];
    x2final             = [x2; x2_vol];
    cues_final          = [allcues; volcues];
    outcomes_final      = [alloutcomes; voloutcomes];
    ...
    clear xfinal x x_vol cues_final outcomes_final alloutcomes allcues voloutcomes volcues
